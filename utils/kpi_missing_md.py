...
def render_missing_md_trend_chart(*args, **kwargs):
    """Render trend chart for Missing MD using standard utility"""
    return render_trend_chart(*args, **kwargs)


def render_missing_md_facility_comparison_chart(*args, **kwargs):
    """Render facility comparison chart for Missing MD using standard utility"""
    return render_facility_comparison_chart(*args, **kwargs)


def render_missing_md_region_comparison_chart(*args, **kwargs):
    """Render region comparison chart for Missing MD using standard utility"""
