...
def render_summary_dashboard(user, facility_name, facility_uid):
    ...
    # Apply professional table styling - EXACTLY LIKE REGIONAL.PY
    st.markdown(
        """
    <style>
    .professional-table {
    ...
    # Newborn Overview Table - Professional Styling - EXACTLY LIKE REGIONAL.PY
    ...
    # Maternal Overview Table - Professional Styling - EXACTLY LIKE REGIONAL.PY
    st.markdown("---")
    ...
    # Summary statistics cards - EXACTLY LIKE REGIONAL.PY
    st.markdown("---")
...
def render():
    ...
    tab1, tab2, tab3 = st.tabs(
        [
            ...
            "👶 **Newborn Care Form**",
            "📊 **Summary Dashboard**",  # ADDED THIS TAB
        ]
    )
